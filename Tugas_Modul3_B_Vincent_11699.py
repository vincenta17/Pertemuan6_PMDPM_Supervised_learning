...
st.markdown("""
        ...
        .stSidebar h3, .stSidebar p, .stSidebar label, .stSidebar h1 {
            color: #ffffff;
...
st.markdown("<h1 style='text-align: center; color: #4CAF50;'>Prediksi IPK - 1699</h1>", unsafe_allow_html=True)
...
if uploaded_file is not None:
    ...
    model_directory = r'D:\Semester 5\Pembelajaran Mesin Dan Mendalam\Model Suprevised Learning (Praktek)\Tugas3_B_11699'
    ...
    if os.path.exists(model_path):
        ...
        mtk3 = st.sidebar.number_input("Nilai Matematika Semester 2.1", 68.8, 100.0)
        mtk4 = st.sidebar.number_input("Nilai Matematika Semester 2.2", 56.0, 100.0)

        ing1 = st.sidebar.number_input("Nilai Bahasa Inggris Semester 1.1", 64.8, 98.0)
        ...
        ind1 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.1", 67.0, 98.8)
        ind2 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 1.2", 70.0, 99.8)
        ind3 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.1", 65.0, 99.8)
        ind4 = st.sidebar.number_input("Nilai Bahasa Indonesia Semester 2.2", 78.0, 100.0)
